...
("</>", [.error("unexpected '>' in end tag ''", 0, 2), .data("</>")]),
("<", [.error("unexpected EOF inside markup structure", 0, 1)]),
...
("<doc <!-- a comment -->></doc>", [.error("invalid character '<' in tag 'doc'", 0, 7), .error("invalid tag 'doc' dropped", 0, 24), .data(">"), .close(name: "doc")])
]
